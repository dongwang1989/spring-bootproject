...
public class ViewcarlicenseDto {
	...
	private List<ViewcarlicenseDto> list;
	...
	public BigInteger getEventLogId() {
		return eventLogId;
	}

	public void setEventLogId(BigInteger eventLogId) {
		this.eventLogId = eventLogId;
	}

	public String getEventLogSysCode() {
		return eventLogSysCode;
	}
	...
	public List<ViewcarlicenseDto> getList() {
		return list;
	}

	public void setList(List<ViewcarlicenseDto> list) {
		this.list = list;
	}
}
