...
/**
 * The persistent class for the carin database table.
 * 
 */
@Entity
@NamedQuery(name="Carin.findAll", query="SELECT c FROM Carin c")
public class Carin implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="CARIN_EVENTLOGID_GENERATOR" )
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="CARIN_EVENTLOGID_GENERATOR")
