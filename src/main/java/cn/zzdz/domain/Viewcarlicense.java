...
/**
 * The persistent class for the viewcarlicense database table.
 * 
 */
@Entity
@NamedQuery(name = "Viewcarlicense.findAll", query = "SELECT v FROM Viewcarlicense v")
public class Viewcarlicense implements Serializable {
