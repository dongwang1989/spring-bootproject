...
/**
 * The persistent class for the carlicense_imp database table.
 * 
 */
@Entity
@Table(name="carlicense_imp")
@NamedQuery(name="CarlicenseImp.findAll", query="SELECT c FROM CarlicenseImp c")
public class CarlicenseImp implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="CARLICENSE_IMP_EVENTLOGID_GENERATOR" )
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="CARLICENSE_IMP_EVENTLOGID_GENERATOR")
