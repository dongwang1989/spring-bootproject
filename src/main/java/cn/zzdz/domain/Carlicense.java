...
/**
 * The persistent class for the carlicense database table.
 * 
 */
@Entity
@NamedQuery(name="Carlicense.findAll", query="SELECT c FROM Carlicense c")
public class Carlicense implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="CARLICENSE_EVENTLOGID_GENERATOR" )
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="CARLICENSE_EVENTLOGID_GENERATOR")
